                ...
                <nav >
                    <div class="position-sticky">
                        <div class="list-group list-group-flush mt-4">
                            ...
                            <a href="../../teacher/student/student.php" class="list-group-item" style="font-size: 20px;">
            ...
            <div class="col-9">
                <div class="container">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-header text-center ">
                                        <h2 class="modal-title m-auto">ADD COURSE</h2>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="" method="post" id="myForm" >
                                            <div class="form-floating">
                                                <input id="coursename" type="text" class="form-control-lg form-control mt-2" placeholder="Course name" name="coursename" autocomplete="off" maxlength="50" required>
                                                <label for="coursename">Course Name</label>
                                            </div>
                                            <div class="form-floating">
                                                <input id="coursecode" type="text" class="form-control-lg form-control mt-3" placeholder="Course code" name="coursecode" autocomplete="off" required>
                                                <label for="course">Course Code</label>
                                            </div>
                                            <div class="form-floating">
                                                <input id="coursetime" type="time" class="form-control-lg form-control mt-3" placeholder="Course time" name="coursetime" autocomplete="off" required>
                    ...
                    <table class="table table-striped table-hover shadow">
                        ...
                        <?php
                            $stmt2 = "SELECT * FROM course WHERE teacher_id='$teacherid' LIMIT {$start}, {$perPage}";
                            ...
                            ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?php echo $data['course_time']; ?></td>
                                        <td><a href="course-student.php?course_id=<?= $data['course_id'] ?>&page=<?= $_GET['page']?>" class="text-primary">View</a></td>
                                        <td>
                                            <div class="d-flex justify-content-center">    
                                                <form method="get">
                                                    <a href="?edit=<?= $data['course_id'] ?>&page=<?= $_GET['page']?>" class='btn btn-outline-success' title='Edit Course'>
                                                    ...
                                                    <a href="?delete=<?= $data['course_id']?>&page=<?=$_GET['page']?>" class='btn btn-outline-danger' title='Delete Course'>
